...
public:
	...
	bool execute(const Dataset & dataset, const std::string & output_file, const std::string & method, bool complete, double (*metric)(const Abstract_Object &, const Abstract_Object &));
	...
	void exact_lloyds(const Dataset & dataset, double (*metric)(const Abstract_Object &, const Abstract_Object &));
	// clustering using lsh range search as assignment method
	void lsh_range_search_clustering(const Dataset & dataset, double (*metric)(const Abstract_Object &, const Abstract_Object &));
	// clustering using hypercube range search as assignment method
	void cube_range_search_clustering(const Dataset & dataset, double (*metric)(const Abstract_Object &, const Abstract_Object &));
	...
	bool update(double (*metric)(const Abstract_Object &, const Abstract_Object &));
