...
Στην περίπτωση του continuous Frechet, πέρα από την αποθήκευσει των καμπυλών στους πίνακες του αρχείου hash.cpp/hpp, για τον υπολογισμό του exact continuous Frechet ανάμεσα
...
ώστε η μετατροπή να χρειαστεί να γίνει μόνο μια φορά για κάπθε καμπύλη εισόδου
...
Όσο αναφορά τη τιμή του δέλτα για τα grids στον discrete Frechet, καλά αποτελέσματα, σε πολύ καλούς χρόνους σε σχέση με το brute force, 
